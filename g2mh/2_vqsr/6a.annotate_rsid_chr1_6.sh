#!/bin/bash
#SBATCH --job-name=rsid_annotate1
...
#SBATCH -o /expanse/projects/sebat1/a1sriniv/g2mh/2_vqsr/logs/annotate_rsid_chr%a.log
#SBATCH -e /expanse/projects/sebat1/a1sriniv/g2mh/2_vqsr/logs/annotate_rsid_chr%a.err
#SBATCH --array=1-6
