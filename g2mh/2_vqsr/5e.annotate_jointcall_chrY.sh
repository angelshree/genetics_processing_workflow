...
#SBATCH -o /expanse/projects/sebat1/a1sriniv/g2mh/2_vqsr/logs/annotate_jointcall_VQSR_chrY.log
#SBATCH -e /expanse/projects/sebat1/a1sriniv/g2mh/2_vqsr/logs/annotate_jointcall_VQSR_chrY.err
...
for i in {1..5}; do # this is the number of chunks
