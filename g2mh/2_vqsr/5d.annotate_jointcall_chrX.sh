...
#SBATCH -o /expanse/projects/sebat1/a1sriniv/g2mh/2_vqsr/logs/annotate_jointcall_VQSR_chrX.log
#SBATCH -e /expanse/projects/sebat1/a1sriniv/g2mh/2_vqsr/logs/annotate_jointcall_VQSR_chrX.err
...
for i in {1..10}; do # this is the number of chunks
