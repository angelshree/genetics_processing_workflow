...
#SBATCH -o /expanse/projects/sebat1/a1sriniv/g2mh/2_vqsr/logs/apply_VQSR_indel.log
#SBATCH -e /expanse/projects/sebat1/a1sriniv/g2mh/2_vqsr/logs/apply_VQSR_indel.err
